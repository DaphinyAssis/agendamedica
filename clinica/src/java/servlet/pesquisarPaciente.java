...
protected void doPost(HttpServletRequest request,HttpServletResponse response)
    ...
    out=response.getWriter();
     ...
     out.println("<div class='CaixaTransparente'>");
     ...
     try
     {
         ...
         if(conexao.abrirConexao())
         {
             ...
             if(intCodigoConsulta!=0)
             {
                 ...
                 out.println("<br><br>");
                 out.println("<a class='Texto button' href='editar_consulta.jsp?codigo_consulta="+intCodigoConsulta+"'>Editar</a> <a class='Texto button' href='excluir_consulta.jsp?codigo_consulta="+intCodigoConsulta+"'>Excluir</a>");
                 out.println("<a href='javascript:history.back()' class='Texto button'>Voltar</a>");
             }
